...
!      parameter (ionmax = 3)
      ...
      double precision pres, eint, cs, enthalpy


! set the mass fractions, z's and a's of the composition

! pure helium composition (use ionmax = 1)
...
! Invoke a simplified subroutine to call EOS
      call helm_wrapper (dens, temp, abar, zbar, pres, eint, cs, enthalpy)
